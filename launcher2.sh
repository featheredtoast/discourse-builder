...
download_binary() {
  ...
  curl -s -o ${package} -L https://github.com/featheredtoast/discourse-launcher2/releases/download/latest/launcher2-latest-${os}-${arch}.tar.gz
  curl -s -o ${package_md5} -L https://github.com/featheredtoast/discourse-launcher2/releases/download/latest/launcher2-latest-${os}-${arch}.tar.gz.md5
